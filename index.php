...
<div class="col-xs-6 col-md-6">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">Charge Rs.100INR  </h4>
                    </div>
...
var request_url="submitpayment.php";
    ...
    window.location.replace("file:///C:/Users/GuestAc/Desktop/razorpay/payment-success.php?oid="+orderID+"&rp_payment_id="+response.razorpay_payment_id+"&rp_signature="+response.razorpay_signature);

    },
    "modal": {
    "ondismiss": function(){
         window.location.replace("file:///C:/Users/GuestAc/Desktop/razorpay/payment-success.php?oid="+orderID);
     }
},
